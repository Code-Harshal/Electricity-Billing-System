...
namespace ElectricityBilling
{
    public partial class Form1 : Form
    {
       ...
       OleDbConnection con = new OleDbConnection(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\Users\Dell\OneDrive\Documents\Databases\Electricity.accdb; Persist Security Info=False;");
       int n;
        public Form1()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    con.Open();
                    cmd.CommandText = "Insert into customer(Cus_ID,[Date],Name,Address,State,City,Email,Mob_No) Values('" + txt_customerID.Text + "','"+dtpDate.Text+"','"  +txtName.Text + "','" + txtAddress.Text + "','" + cmbState.Text + "','" + txtCity.Text + "','" + txtEmail.Text + "','" + txtMobile.Text + "')";
                    cmd.Connection = con;
                    cmd.ExecuteNonQuery();
